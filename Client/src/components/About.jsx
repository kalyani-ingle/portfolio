...
<div className="typewriter"> 
  <section className="section-process">
        <div className="section-container">
              {/* <img src="https://attic.sh/yowd1tyrgmx1k7ipagemc3xpo8xn" height="40" width="40"/> &nbsp; */}
          <div className="process-steps-container container-medium with-padding">
            <div className="process-step-container process-step-1">
              <div className="process-step-title-container">
                <h1 className="process-step-title"> An Architect .&nbsp;</h1>
                <div className="process-step-title-overlay"> An Architect .&nbsp;</div>
              </div>
            </div>
            <div className="process-step-container process-step-2">
              <div className="process-step-title-container">
                <h1 className="process-step-title"> Urban Planner &nbsp; </h1>
                <div className="process-step-title-overlay"> Urban Planner &nbsp; </div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="process-steps-container container-medium with-padding"> 
            <div className="process-step-container process-step-3">
              <div className="process-step-title-container">
                <h1 className="process-step-title"> A Software Developer</h1>
                <div className="process-step-title-overlay"> A Software Developer</div>
              </div>
            </div>
          </div>
        </div>
        <img src="/software_developer.png" height="40" width="40"/>
      </section>
</div>
